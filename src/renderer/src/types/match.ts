...
export interface CreepsPerMinDelta {}

export interface CsDiffPerMinDelta {}

export interface DamageTakenDiffPerMinDelta {}

export interface DamageTakenPerMinDelta {}

export interface GoldPerMinDelta {}

export interface XpDiffPerMinDelta {}

export interface XpPerMinDelta {}
